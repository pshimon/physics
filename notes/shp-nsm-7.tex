...
\frac{\mathbf{x}(t+\Delta t)-\mathbf{x}(t)}
{\Delta t}.
...
\lim_{\Delta t\rightarrow0^{+}}
\left<
\frac{f(x(t+\Delta t),t+\Delta t)-f(x(t),t)}
{\Delta t}
\right>.
\label{eq:Dplus}
\end{equation}
...
\lim_{\Delta t\rightarrow0^{+}}
\left<
\frac{f(x(t),t)-f(x(t-\Delta t),t-\Delta t)}
{\Delta t}
\right>.
\label{eq:Dminus}
\end{equation}
...
the covariance matrix defined by Eq.
(\ref{eq:NaiveRelativisticNoise})
...
\int
d^3k\,
\mathbf E_{\lambda}(\mathbf k)
\cos(\mathbf k\cdot\mathbf x-\omega t+\phi),
\\
\mathbf B(\mathbf x,t)
&=
\sum_{\lambda}
