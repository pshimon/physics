...
=
\frac{e/m}
{\omega_0^2-\omega^2-i\tau_0\omega^3}
\,
\tilde E(\omega).
}
...
P(x)
=
\frac1{\sqrt{2\pi\langle x^2\rangle}}
\exp
\left(
-\frac{x^2}
{2\langle x^2\rangle}
...
\begin{equation}
\boxed{
\left\langle P_{\rm rad}\right\rangle
=
