...
U(x,\tau)
=
\exp\!\left(i\alpha^a(x,\tau)T^a\right).
\]
...
[D_\alpha,D_\beta]
=
[\partial_\alpha+igA_\alpha,
 \partial_\beta+igA_\beta].
\]
...
\[
\boxed{
\text{ordinary Yang--Mills force}
+
\text{world-time force}.
}
\]
...
it labels the Hamiltonian flow on the extended phase space.
