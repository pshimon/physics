...
\subsection{Wave Packet Construction}
...
\subsection{Short-Time Dynamics: Quasi-Classical Motion}
...
\subsection{Dispersion and Collapse}
...
\subsection{Long-Time Dynamics: Revivals}
...
\subsection{Momentum and Boundary Effects}
...
\begin{enumerate}
    \item \textbf{Short-time classical motion:} The packet moves and reflects approximately like a classical particle.
    \item \textbf{Quantum dispersion:} Interference between stationary components spreads the packet.
    \item \textbf{Exact revivals:} The wave packet periodically reconstructs itself due to the quadratic spectrum.
    \item \textbf{Unitary boundary-induced interference:} Reflections at the walls generate characteristic oscillations without dissipation.
\end{enumerate}
