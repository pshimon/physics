...
\subsection{Simple Wigner--In\"on\"u Contraction}
...
\subsection{Example: Poincar\'e \texorpdfstring{$\to$}{→} Galilei}
...
\subsection{Example: \texorpdfstring{$\mathfrak{so}(3) \to \mathfrak{e}(2)$}{so(3)→e(2)}}
...
\subsection{Generalized In\"on\"u--Wigner Contractions}
