\chapter{Einstein--aether Theory: A Detailed Review}
Einstein--aether (EA) theory is one of the most extensively studied
...
(the ``aether'') that spontaneously breaks local Lorentz symmetry
...
Horava gravity, and has become an important testing ground for
...
Einstein--aether theory was developed mainly by  Jacobson
...
At each event the aether selects a unique local time direction.
...
the aether aligns naturally with cosmic time:
...
In Einstein--aether theory a preferred timelike direction exists
...
This is called hypersurface-orthogonal Einstein--aether theory.
...
The aether contributes additional gravitational forces.

Some galactic phenomena can be reproduced.

\subsection{MOND-like Extensions}

Einstein-aether modifications can generate
...
The aether itself behaves as a cosmic medium.
...
SHP global time
$\neq$
Einstein--aether preferred frame.
\end{center}
...
Thus Einstein--aether theory is not excluded.
...
Einstein--aether theory occupies a unique position among modified
gravity theories.
...
Lorentz invariance, Einstein--aether theory remains one of the
